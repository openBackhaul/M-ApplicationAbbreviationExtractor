# Activity : Implement OAM Services
...
* Create an Issue with the following details , 
  * **Title** : Implement OAM Services
  * **Comment** :
    - [ ] Read [Implementing OAM services](https://github.com/openBackhaul/ApplicationPattern/blob/develop/doc/ImplementingApplications/Steps2ImplementOAMServices/Steps2ImplementOAMServices.md)
    - [ ] To the server side code , implement the OAM services.
