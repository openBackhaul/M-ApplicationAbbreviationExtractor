# Activity : Integrate Configuration File
...
* Create an Issue with the following details , 
  * **Title** : Integrate Configuration File
  * **Comment** :
    - [ ] Read [Integrating Configuration file](https://github.com/openBackhaul/ApplicationPattern/blob/develop/doc/ImplementingApplications/Steps2IntegrateConfigFile/Steps2IntegrateConfigFile.md)
