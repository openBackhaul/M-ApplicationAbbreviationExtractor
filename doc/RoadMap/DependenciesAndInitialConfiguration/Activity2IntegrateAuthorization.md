# Activity : Integrate Authorization
...
* Create an Issue with the following details , 
  * **Title** : Integrate Authorization
  * **Comment** :
    - [ ] Read [Integrate Authorization](https://github.com/openBackhaul/ApplicationPattern/blob/develop/doc/ImplementingApplications/Steps2SupportAuthenticationAuthorization/Steps2SupportAuthenticationAuthorization.md)
